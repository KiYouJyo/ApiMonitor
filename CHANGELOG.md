...
## [0.7.0.1] - 2026-08-04（v0.7.0 UI 整理 / 轻量悬浮额度窗 / 图标与顶部布局修复候选包）
...
- 版本：DisplayVersion 0.7.0 / PackageVersion 0.7.0.1（集中版本来源 Directory.Build.props 与 Package.appxmanifest）
