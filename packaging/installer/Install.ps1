...
<#
  ApiMonitor v0.7.0 sideload installer (candidate package version 0.7.0.2)
  ====================================
  ...
  3. Integrity verification:
     ...
     - manifest Publisher matches the certificate Subject;
      - manifest Identity = ApiMonitor and version = 0.7.0.2.
...
function Assert-ManifestIdentity {
    param(
        ...
        [string]$ExpectedVersion = '0.7.0.2'
    )
