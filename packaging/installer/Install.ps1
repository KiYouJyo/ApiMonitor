...
<#
ApiMonitor v0.9.0 sideload installer (candidate package version 0.9.0.0)
  ====================================
...
- manifest Identity = ApiMonitor and version = 0.9.0.0.
...
Write-InstallerLog '==== ApiMonitor v0.9.0 自动安装开始 ===='
    ...
    switch ($action) {
        ...
        'HigherVersionInstalled' {
            Write-InstallerLog (
'已安装更高版本（{0}），v0.9.0 安装程序不会执行降级。' -f $installedPkg.Version) 'ERROR'
